        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Cài đặt nhãn dán</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Cài đặt nhãn dán</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="name" type="text" placeholder="Tên nhãn dán">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($db->num_rows("SELECT * FROM `product_tag` WHERE `id` != '0'") > 0) {
                                            foreach ($db->fetch_assoc("SELECT * FROM `product_tag` WHERE `id` != '0'", 0) as $info) {
                                        ?>
                                                <tr>
                                                    <td><?= $info['id'] ?></td>
